            ...
            <div className="max-w-4xl space-y-10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-[var(--radius)] bg-card border border-border">
                        ...
                        <h3 className="text-lg font-semibold mb-2">HIPAA alignment</h3>
                    ...
                    <div className="p-6 rounded-[var(--radius)] bg-card border border-border">
                        <FileCheck className="h-6 w-6 text-muted-foreground mb-3" />
                        <h3 className="text-lg font-semibold mb-2">SOC 2 principles</h3>
                        <p className="text-sm text-muted-foreground">
